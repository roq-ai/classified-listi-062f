...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Classified Listing`}</title>

        <meta
          name="description"
          content="Unlock a World of Opportunities with Classified Listing - Revolutionizing User Experience in Online Trading and Listing"
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1517292987719-0369a794ec0f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjbGFzc2lmaWVkJTIwYXBwfGVufDB8fHx8MTY5MzQyMjU2N3ww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@timothyhalesbennett?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Unlock a World of Opportunities with Classified Listing - Revolutionizing User Experience in Online Trading and Listing`}
            </Text>
            <Box
