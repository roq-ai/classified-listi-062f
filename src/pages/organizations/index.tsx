...
export function OrganizationListPage(props: OrganizationListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getOrganizations({
        relations: ['user', 'listing.count', 'user_role.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('listing', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'listing',
          header: 'Listing',
          accessorKey: 'listing',
          cell: ({ row: { original: record } }: any) => record?._count?.listing,
        }
      : null,
